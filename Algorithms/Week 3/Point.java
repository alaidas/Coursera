...
public class Point implements Comparable<Point> {
    ...
    private class BySlope implements Comparator<Point>
    {
        ...
        {  
            double first = slopeTo(point1);
            double second = slopeTo(point2);
            /*
            StdOut.printf("%s ", Point.this);
            StdOut.printf("(%s) (%s) ", point1, point2);
            StdOut.printf("First: %f", first);
            StdOut.printf(" Second: %f\n", second);
            */
    ...
    public static void main(String[] args) {
        ...
        StdOut.printf(" NextSlope: %f", p1.slopeTo(p2));
